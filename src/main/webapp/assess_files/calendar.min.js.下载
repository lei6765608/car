...
//            	alert($("#" + c.controlId).find(".currentYear").text() + "/" + $("#" + c.controlId).find(".currentMonth").text() + "/"+$(this).text());
            	var clickDate = new Date($("#" + c.controlId).find(".currentYear").text() + "/" + $("#" + c.controlId).find(".currentMonth").text() + "/"+$(this).text());
            	var newDate = new Date();
            	
//            	alert(clickDate<newDate);
            	
               if(clickDate<newDate){
			...
			$("#" + c.controlId).find(".btn-today").click(function(){
				var d = new Date();
               ...
               $("#" + c.controlId).find(".enabled").html(s(yy, mm-1));
				$("#" + c.controlId).find(".currentYear").text(yy)
				$("#" + c.controlId).find(".currentMonth").text(mm)
				r();
				n.val(yy+'-'+mm+'-'+dd);
				$("#" + c.controlId).hide();
			});
        ...
        function s(a, b) {
            ...
            g = "<table class='tabD'>";
            g += "<tr><th class='f'>\u65e5</th><th>\u4e00</th><th>\u4e8c</th><th>\u4e09</th><th>\u56db</th><th>\u4e94</th><th>\u516d</th></tr>";
            var i = w(),
            l = "",
            p = "",
            t = "";
            ...
            for (var x = 0; x < 6; x++) {
                ...
                for (var y = 0; y < 7; y++) {
                    ...
                    if (c.lowerLimit != NaN && c.lowerLimit > new Date(newDate.getFullYear(), newDate.getMonth(), j) || c.upperLimit != NaN && new Date(newDate.getFullYear(), newDate.getMonth(), j) > c.upperLimit) if (0 < j && j <= o) {
						...
						//console.log(l+"j");
						if(l=="current"){
							g += "<td class='Today'><a class='" + p + " " + l + "'>" + j + "</a></td>"
						}else{
        ...
        k += "      <a class='prevMonth'></a><span class='t_date'><span class='currentYearText'><a class='currentYear'>" + e + "</a>\u5e74</span><span class='currentMonthText'><a class='currentMonth'>" + (f + 1) + "</a>\u6708</span><a class='btn-today'>返回今天</a></span><a class='nextMonth'></a>";
        k += "    </div>";
        ...
        function() {
            if ($("#" + c.controlId + ":hidden").length != 0) {
                ...
                var a = $("#" + c.controlId),
                b = F(n[0]),
                d = Number(n.offset().left);
                b = Number(n.offset().top) + Number(n.outerHeight())-1;
